...
urlpatterns = [
    ...
    url(r'^{prepend}$'.format(prepend=url_prepend), project_views.home, name='home'),
...
#    ),
    ...
    url(r'^{prepend}accounts/'.format(prepend=url_prepend), include('accounts.urls')),
    url(r'^{prepend}crs/'.format(prepend=url_prepend), include('polls.urls')),
    url(r'^{prepend}quiz/'.format(prepend=url_prepend), include('quizzes.urls')),
]
